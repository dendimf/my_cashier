...
export const storesAPI = {
    ...
    listStaff: (storeId) => api.get(`/auth/${storeId}/staff`),
    createStaff: (storeId, data) => api.post(`/auth/${storeId}/staff`, data),
    uploadImage: (storeId, formData) => api.post(`/stores/${storeId}/upload-image`, formData, {
